			...
			<div class="row">
				<div class="col-12">
					<div class="section__wrap">
						<!-- section title -->
						<h2 class="section__title">Lollywood Movies</h2>
						<!-- end section title -->

						<!-- breadcrumb -->
						<ul class="breadcrumb">
							<li class="breadcrumb__item"><a href="index.php">Home</a></li>
							<li class="breadcrumb__item breadcrumb__item--active">lollywood</li>
						</ul>
						<!-- end breadcrumb -->
					</div>
				</div>
			...
			<div class="row">
				<div class="col-12">
					<div class="filter__content">
						...
						<!-- filter btn -->
						<a class="filter__btn" type="button" href="lollywood.php">apply filter</a>
						<!-- end filter btn -->
					</div>
				</div>
			</div>
	...
	<div class="container">
	 <div class="row">
	  ...
	  <?php 
	   ...
	   $lollywood_mov=mysqli_query($con,"select * from addmovie where movie_indus_id='4'");

	    foreach($lollywood_mov as $data)
	    {
        ?>
