				...
				<div class="col-12">
					<div class="section__wrap">
						...
						<ul class="breadcrumb">
							...
							<li class="breadcrumb__item breadcrumb__item--active">Hollywood</li>
						</ul>
						<!-- end breadcrumb -->
					</div>
				</div>
			...
			<div class="row">
				<div class="col-12">
					<div class="filter__content">
						...
						<!-- filter btn -->
						<a class="filter__btn" type="button" href="hollywood.php">apply filter</a>
						<!-- end filter btn -->
					</div>
				</div>
			</div>
...
<div class="container">
	 <div class="row">
	  ...
	  <?php 
	   ...
	   $hollywood_mov=mysqli_query($con,"select * from addmovie where movie_indus_id='2'");

	    foreach($hollywood_mov as $data)
	    {
        ?>
